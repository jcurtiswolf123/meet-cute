...
import { removeAttendee, setAttendeeStatus, setEventStatus } from "@/lib/actions";
    ...
    <div className="max-w-4xl space-y-10">
      ...
      <section className="card p-6">
        ...
        <p className="mt-1 text-xs text-muted">
          Active {event.city} members not already invited. Tap the faces you want at the table. Each
          one gets an email automatically.
        </p>
        {eligible.length === 0 ? (
