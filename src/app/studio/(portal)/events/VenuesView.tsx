...
// Where the connection email's suggestions come from. Was `/studio/venues`,
// its own rail item; folded into Events on 2026-08-16, because a venue and a
// dinner are the same question (where do these people go) and the rail was
// carrying both.
//
...
export async function VenuesView() {
  ...
  return (
    <div>
      <p className="mb-5 text-sm text-muted">
        A place is only ever suggested after someone here confirms it is open, and that confirmation
        expires after {VENUE_FRESH_DAYS} days.
      </p>
